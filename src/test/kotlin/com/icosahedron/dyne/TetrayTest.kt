...
class TetrayTest {
    ...
    @Test fun `increment at index`() {
        val tetray = Tetray(x0, x1, x2, x3)
        assertEquals(Tetray(x0.plusOne(), x1, x2, x3), tetray.increment(0))
        assertEquals(Tetray(x0, x1.plusOne(), x2, x3), tetray.increment(1))
        assertEquals(Tetray(x0, x1, x2.plusOne(), x3), tetray.increment(2))
        assertEquals(Tetray(x0, x1, x2, x3.plusOne()), tetray.increment(3))
    ...
    @Test fun `decrement at index`() {
        val tetray = Tetray(x0, x1, x2, x3)
        assertEquals(Tetray(x0.minusOne(), x1, x2, x3), tetray.decrement(0))
        assertEquals(Tetray(x0, x1.minusOne(), x2, x3), tetray.decrement(1))
        assertEquals(Tetray(x0, x1, x2.minusOne(), x3), tetray.decrement(2))
        assertEquals(Tetray(x0, x1, x2, x3.minusOne()), tetray.decrement(3))
